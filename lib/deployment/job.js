...
module.exports = function(config, etcd){
	...
	return {
		...
		/*
			...
			this writes to proc which does not run the job just record
			our intention to run it
		...
		*/
		...
		loadJobByPath:function loadJob(path, done){
		...
		loadJob:function loadJob(job, done){
			var jobObject = Job(job)
